...
const SignIn = () => {
    ...
    return (
        ...
        <div className="mx-auto mt-10 w-full max-w-md p-8 space-y-3 rounded-xl dark:bg-gray-50 dark:text-gray-800">
            ...
            <form noValidate="" action="" className="space-y-6">
                ...
                <div className="space-y-1 text-sm">
                    ...
                    <div>
                        <button onClick={handleGoogleSignOut} className="block w-full p-3 text-center rounded-sm dark:text-gray-50 dark:bg-green-600">Sign Out</button>
                    </div> 


                    <div className="space-y-3">
                        <button className="block w-full p-3 text-center rounded-sm dark:text-gray-50 dark:bg-violet-600">Sign in</button>
                        <button onClick={handleGoogleSignUp} className="block w-full p-3 text-center rounded-sm dark:text-gray-50 dark:bg-green-600">Continue With Google</button>
                    </div>
